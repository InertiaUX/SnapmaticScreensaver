package com.stimuli
{
   public class Printf
   {
      ...
      public static function printf(param1:String, ... rest) : String
      {
         ...
         var _loc10_:Boolean = !Boolean(param1.match(/%\(\s*[\w\d_]+\s*\)/));
         while(Boolean(_loc5_))
         {
            ...
            if(_loc11_ != undefined)
            {
               ...
               {
                  _loc6_.replacement = padString(String(_loc11_),_loc16_,_loc17_);
               }
               ...
               else if(DATES_FORMATERS.indexOf(_loc12_) > -1)
               {
                  switch(_loc12_)
                  {
                     ...
                     case DATE_YEAR_FORMATTER:
                        _loc6_.replacement = String(_loc11_["fullYear"]).substr(2,2);
                        break;
                     case DATE_MONTH_FORMATTER:
                        _loc6_.replacement = String(_loc11_["month"] + 1);
                        break;
                     ...
                     case DATE_TOLOCALE_FORMATTER:
                        _loc6_.replacement = (_loc11_ as Date).toLocaleString();
                        break;
